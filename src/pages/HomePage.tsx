...
const stats = [
  { value: "230+", icon: TrendingUp }, { value: "$2.4M", icon: Heart }, { value: "12,000+", icon: Users }, { value: "89%", icon: Star },
];

const steps = [
  { number: "01", icon: Lightbulb, gradient: "from-primary/20 via-primary/10 to-transparent", iconBg: "bg-primary/20", iconColor: "text-primary", borderColor: "group-hover:border-primary/50" },
  { number: "02", icon: Users, gradient: "from-secondary/20 via-secondary/10 to-transparent", iconBg: "bg-secondary/20", iconColor: "text-secondary", borderColor: "group-hover:border-secondary/50" },
  { number: "03", icon: TrendingUp, gradient: "from-accent/20 via-accent/10 to-transparent", iconBg: "bg-accent/20", iconColor: "text-accent", borderColor: "group-hover:border-accent/50" },
];

const trustPoints = [
  { icon: BadgeCheck, bgClass: "bg-primary/5", borderClass: "border-primary/20", hoverBorderClass: "hover:border-primary/50", textClass: "text-primary", iconBgClass: "bg-primary/10" },
  ...
  { icon: UserCheck, bgClass: "bg-accent/5", borderClass: "border-accent/20", hoverBorderClass: "hover:border-accent/50", textClass: "text-accent", iconBgClass: "bg-accent/10" },
];
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-background">
        <motion.div 
          className={`absolute inset-0 bg-cover bg-center bg-no-repeat ${isRtl ? "-scale-x-100" : "scale-x-100"}`}
          style={{ backgroundImage: "url('/sahmi-hero-bg.png')" }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.5, ease: "easeOut" }}
        />
        <div className={`absolute inset-0 ${isRtl ? "bg-gradient-to-l" : "bg-gradient-to-r"} from-background/95 via-background/80 to-background/20`} />
        ...
        <div className="container relative z-10 py-24 md:py-40">
          ...
          >
            ...
            <motion.h1 
              variants={fadeInUp}
              className="hero-heading mb-8 text-4xl font-extrabold leading-tight tracking-tight text-foreground md:text-5xl lg:text-7xl"
            >
              {t("home.heroTitle")} {" "}
              <span className="gradient-text drop-shadow-sm">{t("home.heroImpact")}</span>
            </motion.h1>
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-3xl font-bold text-foreground md:text-4xl tabular-nums tracking-tight" dir="ltr">
                  {stat.value}
                </div>
                        ...
                        {[0, 1, 2].map((featureIndex) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              {t(`home.process${index + 1}Feature${featureIndex + 1}`)}
                            </span>
                          </motion.div>
                        ))}
                      </div>
