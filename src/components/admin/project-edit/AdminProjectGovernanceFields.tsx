...
export const AdminProjectGovernanceFields = ({
  ...
  <div className="space-y-6">
    <div>
      <h2 className="text-lg font-semibold text-foreground">{t("adminForm.verificationLifecycle")}</h2>
      <p className="mt-1 text-sm text-muted-foreground">
        {t("adminForm.governanceHelp")}
      </p>
    </div>
    <div className="flex items-center justify-between gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-5">
      <div>
        <Label htmlFor="admin-project-verified" className="text-base">{t("adminForm.verifiedProject")}</Label>
        <p className="mt-1 text-sm text-muted-foreground">
          {t("adminForm.verifiedHelp")}
        </p>
      </div>
      <Switch
    ...
    <div className="grid gap-5 sm:grid-cols-2">
      <div className="space-y-2">
        <Label htmlFor="admin-project-verifier">{t("adminForm.verifiedBy")}</Label>
        <Select
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="none">{t("adminForm.noVerifier")}</SelectItem>
            {owners.map((owner) => (
      ...
      <div className="space-y-2">
        <Label htmlFor="admin-project-verified-at">{t("adminForm.verifiedAt")}</Label>
        <Input
      ...
      <div className="space-y-2 sm:col-span-2">
        <Label htmlFor="admin-project-verification-notes">{t("adminForm.verificationNotes")}</Label>
        <Textarea
      ...
      <div className="space-y-2 sm:col-span-2">
        <Label htmlFor="admin-project-deleted-at">{t("adminForm.softDeletedAt")}</Label>
        <Input
...
export const AdminProjectIntelligenceFields = ({
  ...
  <div className="space-y-6">
    <div>
      <h2 className="text-lg font-semibold text-foreground">{t("adminForm.aiMetadata")}</h2>
      <p className="mt-1 text-sm text-muted-foreground">
        {t("adminForm.intelligenceHelp")}
      </p>
    </div>
    <div className="grid gap-5 sm:grid-cols-2">
      <div className="space-y-2">
        <Label htmlFor="admin-project-ai-category">{t("adminForm.classifiedCategory")}</Label>
        <Input
      ...
      <div className="space-y-2">
        <Label htmlFor="admin-project-ai-confidence">{t("adminForm.confidence")}</Label>
        <Input
      ...
      <div className="space-y-2 sm:col-span-2">
        <Label htmlFor="admin-project-ai-date">{t("adminForm.classificationTime")}</Label>
        <Input
      ...
      <div className="space-y-2 sm:col-span-2">
        <Label htmlFor="admin-project-ai-summary">{t("adminForm.generatedSummary")}</Label>
        <Textarea
