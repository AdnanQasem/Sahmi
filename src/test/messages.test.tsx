...
beforeEach(async () => { await changeLanguage("en"); vi.clearAllMocks(); mocks.markRead.mockResolvedValue({ marked_read: true }); mocks.listMessages.mockResolvedValue({ count: 0, results: [] }); });
